document.addEventListener('DOMContentLoaded', () => {
    ...
    // ===== SECCIÓN MODIFICADA (1/3) =====
    // Se unifica la carga de datos y la actualización de todas las notificaciones
    // en una sola función para mayor claridad.
    function loadAllData() {
        loadAllEmployees();
        loadAllMaintenanceReports();
        loadTechnicalAlerts();
        updateAllNotifications(); // Llamada a la nueva función centralizada
    }
    // ===================================
    ...
    const MAINTENANCE_TYPE_OPTIONS = [ 'PREVENTIVO', 'CORRECTIVO', 'PREDICTIVO', 'FABRICACION', 'SOPORTE' ];
    ...
    function updateAllNotifications() {
        ...
        // 1. Notificación TOTAL en el Menú Principal (tarjeta Mantenimiento)
        ...
        // 2. Notificación individual en el botón "R. Pendientes"
        ...
        // 3. Notificación individual en el botón "Alertas"
    ...
    // =========================================================================
    // ===== FUNCIÓN MODIFICADA PARA PDF DE MANTENIMIENTO CON CAJAS DINÁMICAS =====
    // =========================================================================
    function generateAndActionPdf(reportId, action) {
        ...
        // --- Sección de Datos Generales (sin cambios) ---
        ...
        // Esta es la nueva función interna que dibuja cajas dinámicas
        const drawBox = (title, content, x, y, width) => {
            // Estilos del cuadro y texto
            doc.setFillColor(217, 234, 255); // Azul claro para el título
            doc.setDrawColor(150);
            doc.setLineWidth(0.2);
            
            // Definir alturas y espaciados
            const titleBarHeight = 8;
            const textPadding = 3; // Espacio interno para el texto
            const textLineHeight = 4; // Altura aproximada de una línea de texto

            // Dibujar la barra de título (igual que antes)
            ...
            // Devolver la posición Y final para el siguiente elemento
            return y + totalBoxHeight;
        };
        
        // Rastreadores de posición para cada columna
        let leftColY = currentY;
        let rightColY = currentY;
        const vGap = 5; // Espacio vertical entre cajas

        // Dibujar cajas en secuencia, usando la posición devuelta por la anterior
        ...
        // La nueva posición Y será la del final de la columna más larga
    ...
    // ===== SECCIÓN MODIFICADA (3/3) =====
    // Se corrige el formato del mensaje de WhatsApp para que los emojis se vean bien.
    alertForm.addEventListener('submit', (e) => {
        ...
        // Mensaje creado con template literals para mejor manejo de caracteres especiales.
